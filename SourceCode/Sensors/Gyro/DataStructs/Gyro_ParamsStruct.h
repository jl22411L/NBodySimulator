/*!
 *    @File:         Gyro_ParamsStruct.h
 *
 *    @Brief:        Params Struct for Gyro.
 *
 *    @Date:         05/02/2025
 *
 */

#ifndef H_GYRO_PARAMSSTRUCT_H
#define H_GYRO_PARAMSSTRUCT_H
...
/* Data include */
#include "Gyro/ConstantDefs/Gyro_ConstansDefs.h"

/* Generic Libraries */
/* None */

typedef struct Gyro_ParamsStruct
{
  /*!
   ...
   * @units     N/A
   */
  char gyroName[GYRO_MAX_SENSOR_NAME_BUFFER];
