...
int GMath_invMat(double *p_inputMat_in, double *p_outputMat_out, int sideN_in)
{
  ...
  double upperMatrixBuffer[GMATH_MATRIXINV_BUFFER][GMATH_MATRIXINV_BUFFER];
  double lowerMatrixBuffer[GMATH_MATRIXINV_BUFFER][GMATH_MATRIXINV_BUFFER];
  ...
  GZero(
      ...
      double[GMATH_MATRIXINV_BUFFER][GMATH_MATRIXINV_BUFFER]);
  GZero(
